...
train_dataset = VOCDataset(root_dir='/home/zya/zya/AI/NNet/detection/fcos/FCOS-PyTorch-37.2AP-master/dataset/VOC2007',
...
model = torch.nn.DataParallel(model)  # device_ids = [0, 1]的时候，通过并行计算用多个显卡加速；
